    ...
    <div className='login'>
      ...
      <div className="login-from">
        ...
        <div className="from-switch">
          ...
          {signState==="Sign In"?<p>New User? <span onClick={()=>{setSignState("Sign Up")}}>Sign Up Now</span></p>:<p>Alrady Have Account? <span onClick={()=>{setSignState("Sign In")}}>Sign In</span></p>}
