    ...
    <div className='home'>
      ...
      <div className="hero">
        ...
        <div className="hero-caption">
          ...
          <p>Discovering his ties to a secret ancient order, a young man is living in mordern Istanbul embarks on a quest to save the city from an immortal enemy.</p>
